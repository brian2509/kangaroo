...
const FeedNewStickerPack = (): React.ReactElement => {
    ...
    return (
        <Layout style={tw`flex-col w-full p-2 pl-6 pr-0`}>
            <Layout style={tw`border-b border-gray-100 flex-row justify-between pb-2 pr-4`}>
                ...
                <Layout style={tw`flex-col pl-4 flex-grow`}>
                    <Layout style={tw`flex-row flex-grow justify-between`}>
                        <Text style={tw`font-semibold text-base`}>
                            Relive Fanclub{" "}
                            <Text style={tw`text-gray-500 text-xs font-light self-center`}>
                                10/30{" "}
                            </Text>
                        </Text>
...
export const FeedScreen = ({ navigation }: Props): React.ReactElement => {
    ...
    return (
        <SafeAreaView style={tailwind("w-full h-full")}>
            ...
            <FeedNewStickerPack></FeedNewStickerPack>
        </SafeAreaView>
    );
};
